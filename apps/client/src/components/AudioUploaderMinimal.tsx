...
export const AudioUploaderMinimal = () => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          // Base styling with dark background to match above components
          "relative mx-2 rounded-xl transition-all duration-500 overflow-hidden orbitron-font",
          ...
          isDragging
            ? "shadow-2xl shadow-emerald-400/60 scale-105 border-emerald-400/50"
            : "",
        ...
        <label htmlFor="audio-upload" className="cursor-pointer block w-full relative z-10">
          <div className="p-4 flex items-center gap-4">
            ...
            <div className="flex-1 min-w-0">
              <div className={cn(
                "text-sm font-bold truncate transition-all duration-300 tracking-wide orbitron-font",
                ...
                {isUploading
                  ? "UPLOADING..."
                  : fileName
                  ? trimFileName(fileName).toUpperCase()
                  : "UPLOAD AUDIO"}
              </div>
              
              {!isUploading && !fileName && (
                <div className={cn(
                  "text-xs transition-all duration-300 truncate mt-1 font-medium tracking-wider orbitron-font",
